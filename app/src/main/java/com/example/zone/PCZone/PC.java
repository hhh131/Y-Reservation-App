...
public class
PC extends AppCompatActivity implements PCAdapter.MyRecyclerViewClickListener {
    ...
    String SeatNum;
    private ArrayList<PCMainData> arrayList = new ArrayList<PCMainData>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new PCMainData(seat1, seat2, seat3, seat4, seat5, seat6, seat7, seat8, seat9, seat10, seat11, seat12));
        arrayList.add(new PCMainData(seat13, seat14, seat15, seat16, seat17, seat18, seat19, seat20, seat21, seat22, seat23, seat24));
        arrayList.add(new PCMainData(seat25, seat26, seat27, seat28, seat29, seat30, seat31, seat32, seat33, seat34, seat35, seat36));


        myAdapter = new PCAdapter(arrayList);
                        ...
                        if (datasnapshot.child(SeatNumber).child("status").getValue().equals(true)) {
                           /* if(snapshot.child(loginId).child("seatNum").getValue().equals(SeatNumber))
                            ...
                            if (snapshot.hasChild(loginId)) {
                                ...
                                // 커스텀 다이얼로그를 호출한다.
                                reservationDialog.callFunction("PCZone", SeatNumber,btn);
                            }
                        }
                                ...
                                if (datasnapshot.child(SeatNumber).child("status").getValue().equals(true)) {
                                    ...
                                    if (snapshot.hasChild(loginId)) {
                                      ...
                                      /*  SeatVO seatVO = new SeatVO(loginId, SeatNumber, true);
                                        ...
                                        ReservationDialog reservationDialog = new ReservationDialog(PC.this);
                                        //커스텀 다이얼로그를 호출한다.
                                        reservationDialog.callFunctionPos("PCZone", result.getContents());
  ...
  /*      Intent notificationIntent = new Intent(this, PCZone.class);
...
*/
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
                ...
                .setContentTitle("PCZone "+num+"번 좌석 사용 중")
